<?php
	Class Desbloquearbanca{
		...
		private function desbloquear(){
			$consulta = $this->Comunicacion->Consultar("UPDATE bancas SET bloqueo='no' WHERE usuario='".$_GET["usuariobanca"]."'");
			$consultar = $this->Comunicacion->Consultar("UPDATE usuarios SET bloqueo='no' WHERE nick='".$_GET["usuariobanca"]."'");
