<?php
	Class Bloquearbanca{
		...
		private function bloquear(){
			$consulta = $this->Comunicacion->Consultar("UPDATE bancas SET bloqueo='si' WHERE usuario='".$_GET["usuariobanca"]."'");
			$consultar = $this->Comunicacion->Consultar("UPDATE usuarios SET bloqueo='si' WHERE nick='".$_GET["usuariobanca"]."'");
